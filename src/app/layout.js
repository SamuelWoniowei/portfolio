...
export const metadata = {
  ...
  keywords:
    "frontend developer, web developer, HTML, CSS, JavaScript, React, portfolio, nextjs",
  author: "Samuel Woniowei",
  openGraph: {
    title: "Samuel Woniowei - Frontend Developer Portfolio",
    description:
      "Explore the projects and skills of Samuel Woniowei, a frontend developer.",
  ...
  twitter: {
    ...
    description:
      "Explore the projects and skills of Samuel Woniowei, a frontend developer.",
    images: [
      "https://res.cloudinary.com/shmulky/image/upload/v1704442189/S.png",
    ],
  },
};
